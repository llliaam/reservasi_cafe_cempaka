            ...
            {auth?.user && (
                ...
                >
                    ...
                    <div className="flex-1 p-4 space-y-2">
                        {[
                            { name: 'Home', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', color: 'blue', route: '/' },
                            ...
                            { name: 'Favorites', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z', color: 'pink', route: route('menu-favorit') },
                            {
                                ...
                                color: 'gray',
                                route: route('profile.edit') // Menggunakan profile.edit karena ini adalah rute yang akan memuat halaman pengaturan utama
                            }
                        ].map((item, index) => (
                            item.route ? (
                                <Link
