                        ...
                        <>
                           ...
                           <Label htmlFor="password_confirmation">Confirm password</Label>
                            ...
                            <div className="flex space-x-4">
                                <Button
                                    onClick={backStep}
                                    className="rounded-full bg-gray-600 text-white font-bold hover:bg-gray-700 w-full" >
                                
                                    BACK
                                </Button>
                                <Button type="submit" className="rounded-full bg-gray-600 text-white font-bold hover:bg-gray-700 w-full"  tabIndex={5} disabled={processing}>
